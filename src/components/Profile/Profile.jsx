  ...
  return (
    <section className={styles.profile}>
      <div className={`${styles.profile__wrap} box`}>
        <h1 className={styles.profile__title}>Ilya Koloskov</h1>
        ...
        <div className={styles.profile__info}>
          <ul className="profile__info-list">
            ...
            <li className="profile__info-item">
              <strong className={styles.strong}>Passion: </strong>
              <span className="profile__info-span">Frontend, music, sport</span>
            </li>
          </ul>
        </div>
        <div className={`${styles.profile__btn} btn`}>Send message</div>
      </div>
      <MyPosts />
    </section>
  )
